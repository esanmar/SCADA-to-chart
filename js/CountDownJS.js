...
function CountDownObject() {
	...
	function TimerEnd(){
		...
		CanvasContext.font = 20*param.elementSize + "px Open Sans";
		CanvasContext.textAlign = "center";
		CanvasContext.fillText("PINTADO", Canvas.width/2, 84.5*param.elementSize);
	}
	...
	function DrawText(){
		...
		if(num == 1){
			CanvasContext.fillText("SEGUNDOS", param.sec1Position + 80*0.5*param.elementSize, 150*param.elementSize);
		}else{
			CanvasContext.fillText("SEGUNDOS", param.sec1Position - 80*0.05*param.elementSize, 150*param.elementSize);
		}
		if(num == 3){
			CanvasContext.fillText("MINUTOS", param.min1Position + 80*0.5*param.elementSize, 150*param.elementSize);
		}else if(num > 3){
			CanvasContext.fillText("MINUTOS", param.min1Position - 80*0.05*param.elementSize, 150*param.elementSize);
		}
		if(num == 5){
			CanvasContext.fillText("HORAS", param.hour1Position + 80*0.5*param.elementSize, 150*param.elementSize);
		}else if(num > 5){
			CanvasContext.fillText("HORAS", param.hour1Position - 80*0.05*param.elementSize, 150*param.elementSize);
		}
		if(num == 7){
			CanvasContext.fillText("DIAS", param.day1Position + 80*0.5*param.elementSize, 150*param.elementSize);
		}else if(num == 8){
			CanvasContext.fillText("DIAS", param.day1Position - 80*0.05*param.elementSize, 150*param.elementSize);
		}else{
			CanvasContext.fillText("DIAS", param.day1Position - 80*0.6*param.elementSize, 150*param.elementSize);
		}
	}
